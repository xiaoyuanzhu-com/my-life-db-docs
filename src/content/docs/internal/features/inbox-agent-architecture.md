...
- [agent-components-reference.md](../architecture/agent-components-reference.md) - Detailed component definitions (system prompts, tools, execution flow)
- [architecture.md](../architecture.md) - Overall system architecture
- [components/digest-system.md](../components/digest-system.md) - File processing pipeline
- [components/filesystem-service.md](../components/filesystem-service.md) - Filesystem operations
- [components/claude-code-integration.md](../components/claude-code-integration.md) - Reference for conversation UI patterns
