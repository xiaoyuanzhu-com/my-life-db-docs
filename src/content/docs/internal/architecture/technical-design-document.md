...
- All behavioral details (ranking, debounce strategy, UX flows) are specified in [docs/search-feature-design.md](../features/search-feature-design.md); this document only tracks how search integrates with the file-centric data model.
