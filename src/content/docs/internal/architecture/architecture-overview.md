...
|------|----------|--------------|
| Server lifecycle | [components/server-component.md](/internal/components/server-component/) | Component initialization, shutdown, middleware |
| Configuration | [components/configuration.md](/internal/components/configuration/) | Environment variables, settings |
| Claude Code integration | [components/claude-code-integration.md](/internal/components/claude-code-integration/) | WebSocket, sessions, message handling, permissions |
| File processing | [components/digest-system.md](/internal/components/digest-system/) | Digesters, file metadata extraction |
| Filesystem watching | [components/filesystem-service.md](/internal/components/filesystem-service/) | File watcher, scanner, change events |
| Real-time updates | [components/notifications-service.md](/internal/components/notifications-service/) | SSE, event broadcasting |
| Authentication | [components/authentication.md](/internal/components/authentication/) | OAuth, password auth modes |
| HTTP API | [components/http-api.md](/internal/components/http-api/) | Endpoints, handlers, routes |
| Database | [components/database-layer.md](/internal/components/database-layer/) | SQLite, migrations, queries |
| External services | [components/external-service-integrations.md](/internal/components/external-service-integrations/) | OpenAI, Qdrant, Meilisearch, etc. |
...
All settings come from environment variables. See [components/configuration.md](/internal/components/configuration/).
