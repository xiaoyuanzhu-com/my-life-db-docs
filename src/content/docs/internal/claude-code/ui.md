...
| `type: "control_cancel_request"` | Control protocol message - cancels a pending request (e.g., user pressed Escape). Contains only `request_id`, no user-facing content. See [data-models.md "Cancel Request"](./data-models.md#cancel-request-control_cancel_request). |
