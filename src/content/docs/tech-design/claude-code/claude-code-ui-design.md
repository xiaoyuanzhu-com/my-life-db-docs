...
The Task tool spawns a subagent and has a **special lifecycle** with progress messages. See [claude-code-data-directory.md Section 4h](./claude-code-data-directory.md#4h-task-tool-lifecycle) for the complete message flow.
...
The Task tool spawns a subagent whose messages have `parent_tool_use_id` pointing back to the Task's `tool_use.id`. See [claude-code-data-directory.md "Subagent Message Hierarchy"](./claude-code-data-directory.md#subagent-message-hierarchy--critical) for full details.
...
| `type: "control_cancel_request"` | Control protocol message - cancels a pending request (e.g., user pressed Escape). Contains only `request_id`, no user-facing content. See [claude-code-data-directory.md "Cancel Request"](./claude-code-data-directory.md#cancel-request-control_cancel_request). |
...
See [claude-code-data-directory.md "Subagent Message Hierarchy"](./claude-code-data-directory.md#subagent-message-hierarchy--critical) for full details on message structure and examples.
