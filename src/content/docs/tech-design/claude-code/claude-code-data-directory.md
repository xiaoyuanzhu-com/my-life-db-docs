...
- [claude-code-websocket-protocol.md](./claude-code-websocket-protocol) - Real-time WebSocket protocol for session updates
...
User messages may also be skipped if their `content` consists **entirely** of specific XML tags (with only whitespace between). See [claude-code-ui-design.md Section 6.2](./claude-code-ui-design#62-skipped-message-types) for the complete list and detection logic.
...
**UI Rendering:** See [claude-code-ui-design.md Section 4.G "AskUserQuestion"](./claude-code-ui-design#askuserquestion-integrated-into-chat-input) - renders integrated into the chat input card, similar to permission requests.
...
See [claude-code-websocket-protocol.md](./claude-code-websocket-protocol) for complete documentation.
